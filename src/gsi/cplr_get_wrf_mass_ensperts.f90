...
contains
  ...
  ! INITIALIZE ENSEMBLE MEAN ACCUMULATORS
        ...
        if ( .not. l_use_dbz_directDA ) then !direct reflectivity DA option does not emopy this 
  ...
  ! READ OR SCATTER ENEMBLE MEMBER DATA
            ...
            scatter_or_read: if(do_ens_fast_read) then
                ...
                if ( l_use_dbz_directDA) then
                   call this%general_read_wrf_mass_dirZDA(filename,ps,u,v,tv,rh,cwmr,oz,qr,qs,qg,qnr,w,mype)
                else
                   if( do_radar )then
            ...
            member_data_loop: do ic3=1,nc3d
               ...
               case('qr','QR')
                  ...
                  do k=1,grd_ens%nsig
                     do i=1,grd_ens%lon2
                        do j=1,grd_ens%lat2
                           if (l_use_cvpqx) then ! CV transform
                           ...
                           do i=1,grd_ens%lon2
                               do j=1,grd_ens%lat2
                                   if (l_cvpnr) then
                                       ...
                                       if(mype==0 .and. i==10 .and. j==10 .and. k==10) write(6,*)'updating qnr in hybrid analysis and power transform for qnr : from member-->',n
...
30 format(I0,': read ',A)
  ...
  subroutine general_read_wrf_mass_dirZDA (this,filename,g_ps,g_u,g_v,g_tv,g_rh,g_cwmr,g_oz, &
