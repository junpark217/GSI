...
! set passed variables to public
  ...
  public :: l_plt_be_stats, l_be_T_dep, l_use_cvpqx, l_use_cvpqx_pval
  public :: l_gpht2gmht
  public :: lvldbg
...
! logical, save   :: l_qltn
  ...
  real(r_kind) :: l_use_cvpqx_pval       ! parameter p value for power transformation of qx(qr/qs/qg)
...
!   initialization of the options for using radar obs
    ...
    l_use_cvpqx_pval   = 0.000001           ! chenll:nearly the same as use log transform to qx(qr/qs/qg) 
...
!-----------------------------------------------------------------------
      ...
      case (2,3,4)
         ...
         ! iret = 0
          ...
          !!Rong Kong temporarily  changed the density of hail to graupel to make it consistent with WRF Lin scheme
              Zehnegf = ((m3todBZ * Zefact) * Ki2  /  &
